...
class AzureClient extends PeerConnectionClient {
  ...
  async connect() {
    const speechConfig = SpeechSDK.SpeechConfig.fromSubscription(, "westus2"); 
  }
  async generate() {
...
this.socket = new WebSocket(
  "wss://westus2.voice.speech.microsoft.com/cognitiveservices/websocket/v1?enableTalkingAvatar=true&Ocp-Apim-Subscription-Key=<key>&X-ConnectionId=30F8A079847A4DE4AB7A15A6B17E9DAD",
);
this.socket.onopen = () => {
